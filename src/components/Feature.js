...
export default function Feature() {
  return (
    <section className="features-section">
      <h2 className="secondary-heading features-heading">
        Advanced Statistics
      </h2>
      ...
      <article className="flex features-list">
        <article>
          ...
          <h3 className="feature-heading">Brand Recognition</h3>
          <p className="feature-description">
            Boost your brand recognition with each click. Generic links don’t
            mean a thing. Branded links help instil confidence in your content.
          </p>
        </article>
        <article className="mg-md-top">
          <div className="feature-img-container">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="feature-img"
          ...
          <h3 className="feature-heading">Detailed Records</h3>
          <p className="feature-description">
            Gain insights into who is clicking your links. Knowing when and
            where people engage with your content helps inform better decisions.
          </p>
        </article>
        <article className="mg-lg-top">
          <div className="feature-img-container">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="feature-img"
          ...
          <h3 className="feature-heading">Fully Customizable</h3>
          <p className="feature-description">
